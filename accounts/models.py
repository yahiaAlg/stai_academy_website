...
class Anouncement(models.Model):
    designer_profile = models.ForeignKey(
...
class Notice(models.Model):
    student = models.ForeignKey(
        Student, on_delete=models.SET_NULL, related_name="notice", null=True
    )
...
class Gaurdianship(models.Model):
    parent = models.ForeignKey(
        Profile, related_name="parent", on_delete=models.SET_NULL, null=True
    )
    student = models.ForeignKey(
        Student, related_name="student", on_delete=models.SET_NULL, null=True
    )
